...
public class RestSearchModelHandler extends BaseRestHandler {
    ...
    public List<Route> routes() {
        return ImmutableList.of(
            new Route(RestRequest.Method.GET, String.format(Locale.ROOT, "%s/%s/%s", JVectorKNNPlugin.KNN_BASE_URI, MODELS, SEARCH)),
            new Route(RestRequest.Method.POST, String.format(Locale.ROOT, "%s/%s/%s", JVectorKNNPlugin.KNN_BASE_URI, MODELS, SEARCH))
        );
    }
