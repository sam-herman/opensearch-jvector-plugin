    ...
    public List<Route> routes() {
        return ImmutableList.of(
            new Route(
                ...
                String.format(Locale.ROOT, "%s/%s/{%s}/_train", JVectorKNNPlugin.KNN_BASE_URI, MODELS, MODEL_ID)
            ),
            new Route(RestRequest.Method.POST, String.format(Locale.ROOT, "%s/%s/_train", JVectorKNNPlugin.KNN_BASE_URI, MODELS))
        );
    }
