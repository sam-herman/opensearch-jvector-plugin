 ...
 * Once a caller obtain an instance of a {@link SharedIndexState}, it is guaranteed to
 * be valid until it is returned. {@link SharedIndexState} are reference counted
...
class SharedIndexStateManager {
     ...
     * using {@link JNIService#initSharedIndexState(long, KNNEngine)}.
     *
