...
public class JVectorCompoundFormat extends CompoundFormat {
    ...
    public static class JVectorCompoundReader extends CompoundDirectory {
        ...
        public JVectorCompoundReader(CompoundDirectory delegate, Directory directory, SegmentInfo si) throws IOException {
            this.delegate = delegate;
            this.segmentName = si.name;
            this.directoryBasePath = resolveDirectoryPath(directory);
            String entriesFileName = IndexFileNames.segmentFileName(segmentName, "", JVectorCompoundFormat.ENTRIES_EXTENSION);
            this.entries = readEntries(si.getId(), directory, entriesFileName);
            this.compoundFileName = IndexFileNames.segmentFileName(segmentName, "", JVectorCompoundFormat.DATA_EXTENSION);
            ...
            while (!(dir instanceof FSDirectory)) {
                ...
                if (dir instanceof FilterDirectory) {
                    ...
                    throw new IllegalArgumentException(
                        "directory must be FSDirectory or a wrapper around it but instead had type: " + dirType
                    );
                }
            }
